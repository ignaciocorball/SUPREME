...
namespace Supreme.Forms
{
    public partial class FormConfig : Form
    {
        ...
        private void FormConfig_Load(object sender, EventArgs e)
        {
            ...
            graphics = Properties.Settings.Default.graphics;
            trackBar.Value = OpacityIntergerValue;
            lblOpacity.Text = trackBar.Value + "%";
            if(Properties.Settings.Default.graphics == 1){lblGraphic.Text = "High";} else{lblGraphic.Text = "Normal";}
            LanguageMenuStrip.TopLevel = false;
            LanguageMenuStrip.Parent = panel1;
            LanguageMenuStrip.Dock = DockStyle.Fill;
            GraphicMenuStrip.TopLevel = false;
            GraphicMenuStrip.Parent = panel2;
            GraphicMenuStrip.Dock = DockStyle.Fill;
        ...
        {
            Properties.Settings.Default.graphics = 0;
            lblGraphic.Text = "Normal";
        }
        private void highToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Properties.Settings.Default.graphics = 1;
            lblGraphic.Text = "High";
        }
        private void GraphicMenuStrip_ItemClicked(object sender, ToolStripItemClickedEventArgs e)
        {
            GraphicMenuStrip.Visible = false;
        }
        private void lblLanguage_Click(object sender, EventArgs e)
        {
            ...
            //Graphic
            if (GraphicMenuStrip.Visible)
            {
                GraphicMenuStrip.Hide();
            }
        ...
        private void lblOpacity_Click(object sender, EventArgs e)
        {
            if (trackBar.Visible == true)
            {
                trackBar.Visible = false;
        ...
        private void lblSteamFinder_Click(object sender, EventArgs e)
        {
        ...
        {
            if(Properties.Settings.Default.Opacity == FormsOpacity && Properties.Settings.Default.Language == language && Properties.Settings.Default.graphics == graphics)
            {
                Close();
            }
            else
            {
                ...
                if (dialogResult == DialogResult.Yes)
                {
                    ...
                    Properties.Settings.Default.graphics = graphics;
                    Close();
                }
            }
        ...
        string steamUser;
        string oPath = "C:\\Windows\\System32\\profilePic.jpg";
        float FormsOpacity;
        int graphics;
        int language;
