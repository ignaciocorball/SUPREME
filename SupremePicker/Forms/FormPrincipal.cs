...
namespace formPrincipal
{
    public partial class formPrincipal : Form
    {
        ...
        public void GamersclubPing()
        {
            ...
            if (Supreme.Properties.Settings.Default.isFullHD == 1)
            {
                if (GreenA2.Visible == false) { GreenA2.Visible = true; }
        ...
        public void FaceitPing()
        {
            ...
            if (MSFCBR1 != 0)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else { if (MSFCBR1 < 49) { lblPingFCBR1.ForeColor = Color.LimeGreen; } }
                    }
                }
            ...
            //Panel Faceit colors
            if (MSFCBR1 <= 49) { pictureBox10.BackColor = Color.LimeGreen; }
            else
            {
                if (MSFCBR1 <= 99) { pictureBox10.BackColor = Color.Green; }
                else
                {
                    if (MSFCBR1 <= 160) { pictureBox10.BackColor = Color.Yellow; }
                    else { if (MSFCBR1 > 161) { pictureBox10.BackColor = Color.Red; } }
                }
            }
            ...
            if (Supreme.Properties.Settings.Default.isFullHD == 1)
            {
                if (GreenA3.Visible == false) { GreenA2.Visible = true; }
                //Green
                if (pictureBox10.BackColor == Color.Green || pictureBox10.BackColor == Color.LimeGreen)
                {
                    GreenA3.Parent = picBackground;
        ...
        public void OverViewsPing()
        {
            ...
            if (Supreme.Properties.Settings.Default.isFullHD == 1)
            {
                if (GreenA1.Visible == false) { GreenA2.Visible = true; }
                //Green
        ...
        public void ValvePing()
        {
            ...
            if (Supreme.Properties.Settings.Default.isFullHD == 1)
            {
                if (GreenA4.Visible == false) { GreenA2.Visible = true; }
                //Green
        ...
        private async Task PlatformsPingAsync()
        {
            ...
            try
            {
                ...
                await ping.SendPingAsync("205.185.194.50");                 //Valve Ping Brazil
